...
def build_human(b, p):
    ...
    for side, _ in sides():
        b.add(*box((side * 0.024, -0.062, p["skull"] + 0.008), (0.028, 0.013, 0.010)),
              bone="Head", mat=2)
    b.add(*box((0, -0.068, p["skull"] - 0.010), (0.015, 0.018, 0.032)), bone="Head", mat=1)

    # Челюсть: узкий клин под скулами. Яйцо без неё читается манекеном
    # с любого расстояния, а клин — лицом, даже безымянным.
    b.add(*sphere((0, -0.012, p["skull"] - 0.042), 0.050,
                  scale=(1.06, 1.16, 0.58), segs=14, rings=8), bone="Head", mat=1)
