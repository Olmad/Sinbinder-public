...
namespace Sinbinder.EditorTools
{
    ...
    public static class DemoWalkthrough
    {
        ...
        private static List<Step> Build()
        {
            ...
            // После луча, а не до: перезапущенную первую волну отряд успевал
            // положить сам, прежде чем охотник попадал в кадр, — и проверять
            // луч становилось не на ком (14-HANDOFF §108).
            if (all)
            {
