...
namespace Sinbinder.AOS
{
    ...
    public class AOSConfig : ScriptableObject
    {
        ...
        [Tooltip("Потолок вклада одного модуля в одно действие. "
        ...
        [Tooltip("Сила установки отряда. При единице самая решительная "
               ...
               + "характера, но слабее потолка: установка склоняет, "
               + "а не решает. Ноль отключает рычаг.")]
        [Range(0f, 2f)] public float StrategyScale = 1f;
