...
namespace Sinbinder.Gameplay
{
    ...
    public class PrologueCampSpawner : MonoBehaviour
    {
        ...
        private readonly struct CampMember
        {
            ...
            /// Пол.
            ///
            /// Женский ставится <b>только здесь и только поимённо</b>:
            /// женщины в этом мире — уникальные лица, их не выдаёт
            /// ни жатва, ни полка, ни вылазка. Правило держится не
            /// памятью, а проверкой: см. <c>unique_women</c>
            /// в Tools/check.py.
            ///
