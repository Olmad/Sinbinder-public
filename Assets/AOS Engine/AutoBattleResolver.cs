// Assets/AOS Engine/AutoBattleResolver.cs
...
namespace Sinbinder.AOS
{
    public static class AutoBattleResolver
    {
        ...
        public static AutoBattleResult Resolve(Warrior commander, List<Warrior> squad, List<Warrior> enemies, BattleRecord record = null)
        {
            var strategy = commander.GetStrategy();
